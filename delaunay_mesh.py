from myGeometry import point,segment_intersection,judge_P_in_Cirle_ABC,segment_intersection
...
class mesh:
	...
	def illust(self,bg=(255,255,255,255)):
		...
		w=math.ceil(max([i.x for i in self.points]))+10
		h=math.ceil(max([i.y for i in self.points]))+10
		img=Image.new("RGBA",(w,h),bg)
		dr=ImageDraw.Draw(img)
		fnt=ImageFont.truetype('simsun.ttc')
...
if(__name__=='__main__'):
	ls=[]
	ls.append(point(123,421))
	ls.append(point(129,140))
	ls.append(point(247,530))
	ls.append(point(245,235))
	ls.append(point(345,235))
	ls.append(point(345,735))
	ls.append(point(435,340))
	ls.append(point(465,380))
	ls.append(point(524,230))
	ls.append(point(574,730))
	ls.append(point(624,242))
	ls.append(point(724,442))
